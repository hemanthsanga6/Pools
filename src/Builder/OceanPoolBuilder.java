...
public class OceanPoolBuilder extends PoolBuilder {
	String poolName;
	...
	public Pool build() {
		System.out.println("Pool layout is selected, base is digged, Steel is used as supporting structure, plumbing and electrical works are done, Concrete is added, interior is finished using Fiber Glass, and deck has been added");
		return pool;
	}
}