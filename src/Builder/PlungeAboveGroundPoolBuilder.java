...
public class PlungeAboveGroundPoolBuilder extends PoolBuilder {
	String poolName;
	...
	String poolInterior = "Vinyl Liner";
	...
	public Pool build() {
		System.out.println("Pool layout is selected, Structural Support is used as base, Steel is used as supporting structure, plumbing and electrical works are done, Fiber Glass is added, interior is finished using Vinyl Liner, and deck has been added");
		return pool;
	}
}