...
public class VinylLinerAboveGroundPoolBuilder extends PoolBuilder {
	String poolName;
	...
	String poolInterior = "Vinyl Layer";
	String poolStartUp = "Salt Water";
	String poolDeck = "Tiles";
	
	String structuringMaterial = "Steel";
	String buildingMaterial = "Vinyl Layer";
	
	public VinylLinerAboveGroundPoolBuilder() {
	...
	public Pool build() {
		System.out.println("Pool layout is selected, Structural Support is used as base, Steel is used as supporting structure, plumbing and electrical works are done, Vinyl Layer is added, interior is finished using Vinyl Layer, and deck has been added");
		return pool;
	}
}