...
public class FiberGlassInGroundPoolBuilder extends PoolBuilder {
	String poolName;
	...
	public FiberGlassInGroundPoolBuilder() {
		this.builderName = "Fiber Glass In Ground Pool Builder";
		setPoolType(PoolType.INGROUND);
		setPoolCategory(Category.FIBERGLASS);
	...
	public Pool build() {
		System.out.println("Pool layout is selected, base is digged, Steel is used as supporting structure, plumbing and electrical works are done, Fiber glass is used for construction, interior is finished using fiber glass, and deck has been added");
		return pool;
	}
}