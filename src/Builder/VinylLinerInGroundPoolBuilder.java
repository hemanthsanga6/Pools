...
public class VinylLinerInGroundPoolBuilder extends PoolBuilder {
	String poolName;
	...
	String poolStartUp = "Chlorinated Water";
	String poolDeck = "Wood";
	
	String structuringMaterial = "Steel";
	String buildingMaterial = "Vinyl Liner";
	
	public VinylLinerInGroundPoolBuilder() {
		this.builderName = "Vinyl Liner In Ground Pool Builder";
		setPoolType(PoolType.INGROUND);
		setPoolCategory(Category.VINYLLINER);
	...
	public Pool build() {
		System.out.println("Pool layout is selected, base is digged, Steel is used as supporting structure, plumbing and electrical works are done, vinyl layer is used for construction, interior is finished using plaster of paris, and deck using wood is installed");
		return pool;
	}
}