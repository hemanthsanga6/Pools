...
public class LapAboveGroundPoolBuilder extends PoolBuilder {
	String poolName;
	...
	public LapAboveGroundPoolBuilder() {
	...
	public Pool build() {
		System.out.println("Pool layout is selected, Structural Support is used as base, Steel is used as supporting structure, plumbing and electrical works are done, Concrete is added, interior is finished using Fiber Glass, and deck has been added");
		return pool;
	}
}