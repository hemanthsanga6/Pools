...
public class SpoolPoolBuilder extends PoolBuilder {
	String poolName;
	...
	String poolElectrical = "Thermal Heaters";
	...
	public SpoolPoolBuilder() {
		this.builderName = "Infinity In Ground Pool Builder";
		setPoolType(PoolType.INGROUND);
		setPoolCategory(Category.SPOOL);
		setPoolLayout(PoolLayout.CIRCLE);
		setCost(30000);
	}
	...
	public Pool build() {
		System.out.println("Pool layout is selected, base is digged, Steel is used as supporting structure, plumbing and electrical works are done, Fiber Glass is added, interior is finished using Fiber Glass, and deck has been added");
		return pool;
	}
}