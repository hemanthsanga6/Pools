...
public class ConcreteInGroundPoolBuilder extends PoolBuilder {
	String poolName;
	String description ="in ground";
	double poolCost;
	...
	public ConcreteInGroundPoolBuilder() {
		this.builderName = "Concrete In Ground Pool Builder";
		setPoolType(PoolType.INGROUND);
		setPoolCategory(Category.CONCRETE);
